---
title: Installation
description: Install ty using uvx, uv, pip, pipx, or the standalone installer.
---
...
This will download and run ty without requiring a full installation.
...
ty includes a standalone installer for easy installation.
...
<Tabs>
  ...
  <Tab title="Windows">
    ...
    ```powershell
    powershell -ExecutionPolicy ByPass -c "irm https://astral.sh/ty/0.0.20/install.ps1 | iex"
    ```
  </Tab>
</Tabs>
...
<Info>
  ...
  **Windows:**
  ...
  Alternatively, the installer or binaries can be downloaded directly from [GitHub Releases](https://github.com/astral-sh/ty/releases).
</Info>
...
Install ty globally with [mise](https://github.com/jdx/mise):
...
See the [editor integration](https://docs.astral.sh/ty/editors/) guide to add ty to your editor.
